              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap mb-5">
                    <div class="me-5 mt-3">
                      <p>Order value</p>
                      <h3 class="text-info fs-30 font-weight-medium">12.3k</h3>
                    </div>
                    <div class="me-5 mt-3">
                      <p>Orders</p>
                      <h3 class="text-info fs-30 font-weight-medium">14k</h3>
                    </div>
                    <div class="me-5 mt-3">
                      <p>Users</p>
                      <h3 class="text-info fs-30 font-weight-medium">71.56%</h3>
                    </div>
                    <div class="mt-3">
                      <p>Downloads</p>
                      <h3 class="text-info fs-30 font-weight-medium">34040</h3>
                    </div>
                  </div>
                        ...
                        <div class="row">
                          <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                            <div class="ml-xl-4 mt-3">
                              ...
                              <h1 class="text-info">$34040</h1>
                              <h3 class="font-weight-500 mb-xl-4 text-info">North America</h3>
